...
| ----------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `effect`          | `4.0.0-rc.115` (`pnpm-workspace.yaml:93`)                                                                                                                                                              | `sleep`               | 92 files across `apps/*/src` and `packages/*/src` import `effect`; 34 in `packages/sleep/src` alone. Declared by all 14 packages, always as `catalog:`. The MCP protocol itself comes from `effect/unstable/ai` (`apps/mcp/src/server.ts:4`), and the OTLP exporter from `effect/unstable/observability` (`packages/telemetry/src/index.ts:30`), so neither adds a node of its own. |
