...
**Input:** `query` required; `budget_chars` optional, defaulting to 16000 (`packages/index/src/disclosure.ts:23`, `packages/index/src/retrieval.ts:435`); `workspace` optional.
