 ...
 *
 * The row is decoded rather than cast, which is what makes the single declaration load-bearing:
 ...
 * non-positive dimension. What SQLite does not enforce is the TYPE — probed 2026-08-12, INTEGER
 ...
 * refuses to write against a missing watermark, while the two report paths render it as "not yet
