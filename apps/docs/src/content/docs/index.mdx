...
Install the binary and work through the four tutorials in order. The install is a clone and a
build, because no package is published to a registry. If you are an AI agent rather than a person,
