...
### Committed sidecar { #committed-sidecar }
...
### Conflict assist and frame key { #conflict-assist-and-frame-key }
...
### Degraded retrieval { #degraded-retrieval }
...
### Disclosure fold { #disclosure-fold }
...
### Discrimination gate { #discrimination-gate }
...
### The git tree as system of record { #the-git-tree-as-system-of-record }
...
### Last-wins consolidation { #last-wins-consolidation }
...
### `mrr` and `corpusMrr` { #mrr-and-corpusmrr }
...
### Retention triage and reprieve { #retention-triage-and-reprieve }
...
### The three write doors { #the-three-write-doors }
